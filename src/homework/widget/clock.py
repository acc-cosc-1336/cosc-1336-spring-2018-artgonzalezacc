...
class Clock(object):
    ...
    def draw_clock_face(self):
        ...
        # after.
        utc_hour = (get_hours_since_midnight(self.now)) % 24

        self.hour = time_from_utc(self.diff, utc_hour)
    ...
    def draw_minute_hand(self):
        self.minutes = get_minutes((self.now))
    ...
    def draw_second_hand(self):
        self.seconds = get_seconds(self.now)
